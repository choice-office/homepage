...
export const SERVICES: Service[] = [
	...
	},
	{
		...
		period: "약 6개월 ~ 1년 이상 (심사 특성상 장기 소요)",
	},
];
...
export const FAQ = [
	{
		q: "상담은 정말 무료인가요?",
		a: "네. 초기 상담은 무료로 진행합니다. 상황을 듣고 현재 가능한 방향과 대략적인 절차를 먼저 안내드립니다.",
	},
	{
		q: "영어로도 상담이 가능한가요?",
		a: "한국어와 영어 상담을 지원합니다. 미국·중국 등 해외 의뢰인의 비자·체류 문의도 도와드립니다.",
	},
	{
		q: "사무장이 아니라 행정사가 직접 상담하나요?",
		a: "그렇습니다. 사무장 없는 사무소로, 상담·서류 작성·접수까지 시험 출신 행정사가 직접 수행합니다.",
	},
	{
		q: "승인을 보장해 주시나요?",
		a: "결과를 단정해 약속드리지 않습니다. 대신 요건을 정확히 검토해 가능성과 현실적인 방향을 솔직하게 안내드립니다.",
	},
];
